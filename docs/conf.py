...
project = u'imaug'
copyright = u'%d, imaug contributors' % (datetime.datetime.now().year,)
author = u'imaug contributors'
...
latex_documents = [
    (master_doc, 'imaug.tex', u'imaug Documentation',
     u'imaug contributors', 'manual'),
]
...
man_pages = [
    (master_doc, 'imaug', u'imaug Documentation',
     [author], 1)
]

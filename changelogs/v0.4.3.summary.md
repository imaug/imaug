...
NumPy 2.3 [removed](https://numpy.org/doc/stable/release/2.3.0-notes.html#expired-deprecations) the [previously](https://numpy.org/doc/stable/release/1.20.0-notes.html#indexing-errors-will-be-reported-even-when-index-result-is-empty) depreciated out-of-bound indexes on empty arrays. This caused test failures for zero-sized array axes `meta.py`. To continue support for the given test set, mitigations
were set in place.

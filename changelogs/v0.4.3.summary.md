...
## Remove install dependency on removed pkg_resources [#2](https://codeberg.org/imaug/imaug/pulls/2)
...
## Limit supported opencv-python version [#3](https://codeberg.org/imaug/imaug/pulls/3)
...
## Limit max supported numpy version [#3](https://codeberg.org/imaug/imaug/pulls/3)
